...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { description: @partner.description, name: @partner.name } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { description: @partner.description, name: @partner.name } }
